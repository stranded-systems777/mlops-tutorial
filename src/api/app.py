...
app = FastAPI(title="House Price Prediction API", description="ML model PI for predicting house prices", version="1.0.0")
...
class HouseFeatures(BaseModel):
    ...
    location_score: float = Field(..., ge=0, le=10, description="Location quality score")  
